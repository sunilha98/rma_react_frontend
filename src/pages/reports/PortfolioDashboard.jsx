...
const PortfolioReport = () => {
  ...
  return (
    <>
      <style>{`
        .gradient-header {
          background: linear-gradient(135deg, #f6d365 0%, #fda085 30%, #fbc2eb 70%, #a6c1ee 100%);
        ...
        .gradient-header-table::after {
          ...
          right: 0;
          height: 3px;
          background: linear-gradient(90deg, #f6d365, #fda085, #fbc2eb, #a6c1ee);
        }
        .table-row-custom {
        ...
        .table-row-custom:hover {
          background: rgba(246, 211, 101, 0.08) !important;
      ...
      >
        ...
        <div className="position-relative">
          <div className="d-flex align-items-center">
            ...
            <div>
              <h3 className="mb-1 fw-bold">Portfolio</h3>
              <p className="mb-0 opacity-75">Overview of all client projects and practices</p>
            </div>
          </div>
        </div>
      </div>
              ...
              {data.length === 0 ? (
                <tr>
                  <td colSpan="3" className="text-center py-5 text-muted">
                    <div className="d-flex flex-column align-items-center">
                      <i className="bi bi-briefcase display-1 mb-3 opacity-25"></i>
                      <h5 className="mb-2">No portfolio projects found</h5>
                ...
                data.map((item, index) => (
                  <tr key={index} className="table-row-custom">
                    ...
                    <td className="py-3 px-4">{item.practice}</td>
