      ...
      >
        ...
        <div className="position-relative">
          <div className="d-flex align-items-center">
            ...
            <div>
              <h3 className="mb-1 fw-bold">Lessons Learned</h3>
              <p className="mb-0 opacity-75">Insights and takeaways from completed projects</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <table className="table table-hover mb-0 custom-table">
            <thead>
              <tr className="gradient-header-table text-white">
                ...
                <th className="border-0 fw-semibold py-3 px-4">Insight</th>
                <th className="border-0 fw-semibold py-3 px-4">Category</th>
              </tr>
            </thead>
            <tbody>
              {data.length === 0 ? (
                <tr>
                  <td colSpan="3" className="text-center py-5 text-muted">
                    <div className="d-flex flex-column align-items-center">
                      ...
                      <p className="mb-0">Check back later for project insights</p>
                    </div>
                  </td>
                </tr>
              ) : (
