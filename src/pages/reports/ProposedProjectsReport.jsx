...
const ProposedProjectsReport = () => {
  const [data, setData] = useState([]);

  useEffect(() => {
    api.get('/reports/proposed')
  ...
  return (
    <>
      <style>{`
        .gradient-header {
          background: linear-gradient(135deg, #ff9a9e 0%, #fad0c4 30%, #fbc2eb 70%, #a18cd1 100%);
        ...
        .table-row-custom:hover {
          background: rgba(255, 154, 158, 0.08) !important;
      ...
      >
        ...
        <div className="position-relative">
          <div className="d-flex align-items-center">
            ...
            <div>
              <h3 className="mb-1 fw-bold">Proposed Projects</h3>
              <p className="mb-0 opacity-75">Potential projects under consideration</p>
            </div>
          </div>
        </div>
      </div>
                ...
                <tr>
                  <td colSpan="5" className="text-center py-5 text-muted">
                    <div className="d-flex flex-column align-items-center">
                      <i className="bi bi-lightbulb display-1 mb-3 opacity-25"></i>
                      <h5 className="mb-2">No proposed projects found</h5>
...
export default ProposedProjectsReport;
